package ua.turskyi.gdgfinder.search
...
import ua.turskyi.gdgfinder.network.GdgChapter
import ua.turskyi.gdgfinder.search.GdgListAdapter.GdgListViewHolder
import ua.turskyi.gdgfinder.databinding.ListItemBinding

class GdgListAdapter(private val clickListener: GdgClickListener): ListAdapter<GdgChapter, GdgListViewHolder>(
    DiffCallback
){
